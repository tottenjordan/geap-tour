...
COORDINATOR_CHECKS: tuple[Check, ...] = (
    ...
    Check(
        ...
        why=(
            ...
            "so templates ARE active on it. .env's AGENT_MODEL was gemini-3.5-flash "
            "until 2026-09-17 and is now 2.5, so a default deploy stays on templates; "
            "Gemini-3 is opt-in. ADK 2.8.0 "
